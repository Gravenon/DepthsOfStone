...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        public Text actionLabelTextOverride
        {
            get => m_ActionLabelTextOverride;
            set
            {
                m_ActionLabelTextOverride = value;
                UpdateActionLabel();
            }
        }
        ...
        [Tooltip("Optional custom text for the action label. If empty, the action name is used.")]
        [SerializeField]
        private Text m_ActionLabelTextOverride;
        ...
        private void UpdateActionLabel()
        {
            ...
            {
                var action = m_Action?.action;
                if (m_ActionLabelTextOverride != null)
                    m_ActionLabel.text = m_ActionLabelTextOverride.text;
                else
        ...
        {
            var currentBindings = PlayerPrefs.GetString(m_Action.action.name + bindingId);
            if (!string.IsNullOrEmpty(currentBindings))
                actionReference.action.actionMap.LoadBindingOverridesFromJson(currentBindings);
        }
